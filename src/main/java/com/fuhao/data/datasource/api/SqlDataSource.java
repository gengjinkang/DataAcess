...
public class SqlDataSource implements DataSource {
	...
	private static final String SOURCENAME="mysql";
	...
	public SqlDataSource(DruidDataSource dataSource) {
	...
	private void init()  {
		...
		dataSource.setUrl(Configurations.PROPERTIES.getProperty("mysql.url"));
